...
function infoDraw(info = false) {
    if (info) {
        ...
        const rate_percent = parseInt((info.rating / 2500) * 100)
        ...
        if (info.tags) {
            info.tags = info.tags.map(function (info_tag) {
                return "<a href='./search.html?page=1&show=10&&tag=" + info_tag + "&rate_min=0&rate_max=2500'>" + info_tag + "</a>";
            })
        ...
        info_author.href = "./search.html?page=1&show=10&author=" + info.created_by_unix + "&rate_min=0&rate_max=2500"
